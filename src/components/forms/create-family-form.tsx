...
import { createFamilyAction, type CreateFamilyFormState } from "@/actions/family.actions";
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4" noValidate>
      <div className="flex flex-col gap-2">
        ...
        <Input id="name" name="name" type="text" placeholder="Например, Ивановы" required />
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input id="description" name="description" type="text" placeholder="Пара слов об архиве" />
